...
class Archer(physics.Physics, pg.sprite.Sprite):
  ...
  def __init__(self, speed, walk_im, rect,
    ...
    self.speed = speed                # the speed Archer moves at
    self.curr_frames = []             # the current set of frames to flip thru
    self.image = None                 # the current image of Archer to display
...
#    self.sound_swoosh = pg.mixer.Sound("assets/soundfx/sword_swipe.wav")
  ...
  # Calculate Archer's position in this frame
  ...
  # Check if Archer is making contact with something below
